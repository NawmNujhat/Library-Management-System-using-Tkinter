...
def bookRegister():
    ...
    insertBooks = "insert into "+bookT+" values ('"+bid+"','"+title+"','"+author+"','"+status+"','"+category+"')"
    try:
...
def addBook():
    global bookInfo1, bookInfo2, bookInfo3, bookInfo4,bookInfo5, Canvas1, con, cur, bookT, root
    mypass = "Na8*m"
    mydatabase = "library"
    root = Tk()
